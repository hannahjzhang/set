...
boolean sameColor(Card a, Card b, Card c) {
  // remember, col and row start from 0
...
boolean isSet(Card a, Card b, Card c) {
  return ((sameShape(a,b,c)||diffShape(a,b,c)) && (sameFill(a,b,c)|diffFill(a,b,c)) && 
          (sameColor(a,b,c)||diffColor(a,b,c)) && (sameCount(a,b,c)||diffCount(a,b,c)));
}
